  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-nutrition py-12 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      >
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            >
              <p className="text-white/80">
                ...
                <Link
                  href="/auth/register"
                  className="font-semibold text-white hover:text-white/80 transition-colors duration-200 underline decoration-white/30 hover:decoration-white/50 flex items-center justify-center mt-2"
                >
                  Create Account
        ...
        >
          <Link href="/forgot-password" className="hover:text-white/80 underline">
